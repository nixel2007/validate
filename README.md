...
// Создаем некорректный адрес
НекорректныйАдрес = Новый Адрес;
НекорректныйАдрес.Город = ""; // Пустой город
НекорректныйАдрес.Индекс = 12345; // Меньше минимума
НекорректныйПользователь.Адрес = НекорректныйАдрес;
