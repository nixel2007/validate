...
Процедура ОбработатьПоляКласса(Объект, ДанныеВалидации, РезультатВалидации)
	...
	Для Каждого Свойство Из Свойства Цикл
		...
		// todo: нужно сохранять список валидаций в поле 
		// + дать возможность указывать делегаты для их создания (для внедрения зависимостей).
		...
		Если Рефлектор.МетодСуществует(Валидация, "УстановитьВалидатор") Тогда
			Валидация.УстановитьВалидатор(ЭтотОбъект);
		КонецЕсли;
