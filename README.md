...
### Пример 2: Валидация корректных данных
...
Если РезультатВалидации.Количество() = 0 Тогда
    Сообщить("Данные корректны!");
Иначе
    Сообщить("Обнаружены ошибки валидации:");
    Сообщить(Валидатор.ОписаниеОшибокВалидации(РезультатВалидации));
КонецЕсли;
```

### Пример 3: Валидация некорректных данных
...
### Пример 4: Обработка отдельных нарушений
...
Пользователь.Email = "petr@example.com";
Пользователь.Активен = Истина;
